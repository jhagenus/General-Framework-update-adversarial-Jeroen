...
class model_template():
        ...
        if data_set is not None:
            ...
            if behavior == None:
                ...
                if hasattr(self.splitter, 'Train_index'):
                    ...
                    # Remove test perturbation indicator from model file
                    # Testing scenarios do not influence trained model
    ...
    def provide_batch_data(self, mode, batch_size, val_split_size = 0.0, ignore_map = False):
        ...
        if mode == 'pred':
            ...
            N_O = np.minimum(self.N_O_data, self.max_t_O_train)
            Ind_advance = [np.arange(len(self.N_O_data)), np.array([], int)]
